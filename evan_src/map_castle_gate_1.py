...
def castle_gate_1_macro(evan: 'Ricky'):
    ...
    def setup_stationaries():
        evan.teleport_right()
        evan.teleport_left(should_z=random.choice([True, False]), z_delay_before_attack=uniform(0.08, 0.15))
        evan.teleport_up(should_z=random.choice([True, False]), z_delay_before_attack=uniform(0.08, 0.15))
        evan.teleport_left(should_z=random.choice([True, False]), z_delay_before_attack=uniform(0.08, 0.15))
        evan.teleport_left(should_z=random.choice([True, False]), z_delay_before_attack=uniform(0.08, 0.15))
        ...
        evan.janus()
        evan.teleport_down()
        evan.teleport_right(should_z=random.choice([True, False]), z_delay_before_attack=uniform(0.08, 0.15))
        evan.teleport_right(should_z=random.choice([True, False]), z_delay_before_attack=uniform(0.08, 0.15))
        evan.teleport_right(should_z=random.choice([True, False]), z_delay_before_attack=uniform(0.08, 0.15))
        evan.teleport_right(should_z=random.choice([True, False]), z_delay_before_attack=uniform(0.08, 0.15))
